    ...
    return (
        <div className="space-y-4">
            <div className="group categories-full-bleed mx-auto w-full max-w-6xl overflow-hidden">
                <Carousel
                    opts={{ align: "start", slidesToScroll: "auto", dragFree: true, containScroll: "trimSnaps" }}
                    className="w-full"
                >
                    <CarouselContent
                        viewportClassName="cursor-grab active:cursor-grabbing"
                        className="categories-carousel-content gap-3"
                    >
                    ...
                    <CarouselOverlayPrevious
                        variant="ghost"
                        size="icon-sm"
                        className="left-0 top-1/2 -translate-y-1/2 pointer-events-none opacity-0 transition group-hover:opacity-100 group-hover:pointer-events-auto disabled:opacity-0"
                    />
                    <CarouselOverlayNext
                        variant="ghost"
                        size="icon-sm"
                        className="right-0 top-1/2 -translate-y-1/2 pointer-events-none opacity-0 transition group-hover:opacity-100 group-hover:pointer-events-auto disabled:opacity-0"
                    />
                </Carousel>
            </div>
        </div>

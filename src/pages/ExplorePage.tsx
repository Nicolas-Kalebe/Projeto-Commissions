      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center lg:w-auto">
          ...
          <Select defaultValue="relevancia">
            ...
            <SelectContent>
              <SelectItem value="relevancia">RelevÃƒÂ¢ncia</SelectItem>
              <SelectItem value="recentes">Mais recentes</SelectItem>
              <SelectItem value="preco">Menor preÃƒÂ§o</SelectItem>
            </SelectContent>
          </Select>
          <Sheet>
            ...
            <SheetContent side="right">
              <SheetHeader>
                <SheetTitle>Filtros avanÃƒÂ§ados</SheetTitle>
                <SheetDescription>
                  Ajuste o estilo, prazo e faixa de preÃƒÂ§o.
                </SheetDescription>
              </SheetHeader>
              <div className="mt-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select defaultValue="7dias">
                    ...
                    <SelectContent>
                      <SelectItem value="7dias">AtÃƒÂ© 7 dias</SelectItem>
                      <SelectItem value="15dias">AtÃƒÂ© 15 dias</SelectItem>
                      <SelectItem value="30dias">AtÃƒÂ© 30 dias</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium">Faixa de preÃƒÂ§o</p>
